...
In addition to my interest in my own listening habits outside of Spotify's end of year summary, I'm using this app as a tool to learn how to maintain code and data that is updated regularly. In addition, I'm practicing my SQL skills with data management and extraction.  
